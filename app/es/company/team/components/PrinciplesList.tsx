...
const principleItems = [
  {
    ...
    title: "Un Núcleo Pequeño y Dedicado",
  ...
  },
  {
    ...
    title: "Maestros de la Traducción",
    description: "Nuestra especialidad es volver claro lo complejo, tendiendo puentes entre la tecnología intrincada y las necesidades humanas tangibles."
  },
  {
    icon: (
      <svg width="24" height="24" className="h-6 w-6 block align-middle">
    ...
    description: "Usted interactúa directamente con los expertos que diseñan su solución. Sin intermediarios ni traspasos de responsabilidades; solo comunicación clara y un sentido de propiedad inquebrantable."
  },
  {
    icon: (
      <svg width="24" height="24" className="h-6 w-6 block align-middle">
    ...
    title: "Conocimiento Experto, Aplicado en Todo Nivel",
    description: "Cada aspecto de su proyecto es gestionado por profesionales experientes. No delegamos el pensamiento estratégico ni las tareas críticas."
  },
  {
    icon: (
      <svg width="24" height="24" className="h-6 w-6 block align-middle">
    ...
    description: "Nuestro trabajo se guía por convicciones profundas en la transparencia, la excelencia artesanal y la tecnología que verdaderamente sirve a las personas.",
    isLast: true
  }
];
