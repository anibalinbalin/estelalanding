...
const content = {
  en: {
    highlight: "Our work speaks for us.",
    rest: "Though sometimes we speak too. Here are some examples."
  },
  es: {
    highlight: "Nuestro trabajo habla por nosotros.",
    rest: "Aunque a veces también hablamos nosotros. Aquí, algunos ejemplos."
  }
};
