...
const getValuesData = (language: 'en' | 'es') => {
  const content = {
    ...
    es: [
      ...
      {
        title: "Curiosidad",
        description: "Somos aprendices, siempre hay algo nuevo, día a día, sin miedo a aprender algo nuevo, ya sea una nueva tecnología intimidante o un problema desconcertante."
      },
      {
        title: "Diversidad",
