        ...
        <section>
            <div className="w-[100%] px-5 min-[600px]:px-10">
                <div className="m-auto max-w-[1200px]">
                    <h2 className="text-balance textWrapStyle-[balance] m-0 text-[var(--content-raise-p3)] text-[1.5625rem] min-[600px]:text-4xl min-[1000px]:text-[3.125rem] font-normal min-[600px]:font-normal min-[1000px]:font-normal mb-6 min-[600px]:mb-10 min-[1000px]:mb-14 text-center min-[600px]:text-left font-[SuisseIntl,-apple-system,BlinkMacSystemFont,Helvetica,Arial,sans-serif] min-[600px]:font-[SuisseIntl,-apple-system,BlinkMacSystemFont,Helvetica,Arial,sans-serif] min-[1000px]:font-[SuisseIntl,-apple-system,BlinkMacSystemFont,Helvetica,Arial,sans-serif] leading-8 min-[600px]:leading-[2.625rem] min-[1000px]:leading-[110%] tracking-wide min-[600px]:tracking-normal min-[1000px]:tracking-normal min-[800px]:pr-6">Infrastructure & Networks<br /><span className="text-[var(--content-raise-p3)]">The foundation of everything digital.</span><br /><span style={{color: 'color(display-p3 0.4941 0.5137 0.5216)', fontSize: '36px', lineHeight: '42px', fontWeight: '400', fontStyle: 'normal'}}>End-to-end network solutions with proactive monitoring and support.</span></h2>
                </div>
            </div>
                                    ...
                                    <div className="relative z-10 col-span-5 block min-[900px]:ml-[-1.5rem]"><a href="/product/compute" className="flex items-center text-inherit [text-decoration:inherit] transition-opacity ease-[cubic-bezier(.4,0,.2,1)] duration-[.2s]">
                                        ...
                                        <div className="mt-3 min-[900px]:ml-[3.75rem]">
                                            ...
                                            <div className="mt-8">
                                                ...
                                                <div className="px-2.5 py-2 flex items-center gap-2 border-t font-[SuisseIntl,-apple-system,BlinkMacSystemFont,Helvetica,Arial,sans-serif] font-normal leading-[1.125rem] text-[.875rem] tracking-wider text-[var(--content-secondary-p3)] border-[var(--stroke-secondary-p3)]"><svg width="24" height="24" className="block align-middle h-4 w-4 text-[#f5b944]">
