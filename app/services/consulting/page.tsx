export default function ConsultingPage() {
  return (
    <>
              ...
              <div className="w-[100%] px-5 min-[600px]:px-10">
                <div className="m-auto grid max-w-[1200px] grid-cols-[repeat(12,minmax(0,1fr))] items-center gap-6 min-[600px]:gap-6 min-[1000px]:gap-8 mt-[calc(5rem_*_calc(1_-_var(--tw-space-y-reverse)))] min-[1000px]:mt-[calc(9rem_*_calc(1_-_var(--tw-space-y-reverse)))]">
                  <div className="col-span-12 min-[700px]:col-span-7 self-center">
                    <h2 className="col-span-12 text-balance textWrapStyle-[balance] m-0 text-[var(--content-raise-p3)] text-[1.5625rem] min-[1000px]:text-4xl font-normal min-[1000px]:font-normal font-[SuisseIntl,-apple-system,BlinkMacSystemFont,Helvetica,Arial,sans-serif] min-[1000px]:font-[SuisseIntl,-apple-system,BlinkMacSystemFont,Helvetica,Arial,sans-serif] leading-8 min-[1000px]:leading-[2.625rem] tracking-wide min-[1000px]:tracking-normal mb-4 min-[800px]:mb-6">Translating Complexity into Strategic Advantage</h2>
                  ...
                  <div className="col-span-12 min-[700px]:col-start-[8] min-[900px]:col-start-[9] min-[700px]:col-span-5 min-[900px]:col-span-4 self-center rounded-[var(--border-radius-xl)] border bg-[var(--surface-raise-p3)] border-[var(--stroke-secondary-p3)] shadow-[var(--elevation-2)]">
                    <div className="border-b p-6 border-b-[var(--stroke-secondary-p3)]">
                      ...
                      <a href="mailto:hola@este.la" className="text-[#ecbb5a] dark:text-[#ecbb5a] [text-decoration:inherit] flex items-center gap-1 hover:text-[var(--content-accent-p3)]">
                        hola@este.la
                    ...
                    <div className="border-b p-6 border-b-[var(--stroke-secondary-p3)]">
                      ...
                      <div className="space-y-2">
                        <a href="/method" className="text-[#ecbb5a] dark:text-[#ecbb5a] [text-decoration:inherit] flex items-center gap-1 hover:text-[var(--content-accent-p3)] block">
                          Our Method
                          <svg width="12" height="12" className="block align-middle text-[#f5b944]">
                            <use href="/assets/sprite-Dt029LRi.svg#next-arrow-12"></use>
                          </svg>
                        </a>
                        <a href="/services/infrastructure" className="text-[#ecbb5a] dark:text-[#ecbb5a] [text-decoration:inherit] flex items-center gap-1 hover:text-[var(--content-accent-p3)] block">
                          Infrastructure Services
                          <svg width="12" height="12" className="block align-middle text-[#f5b944]">
                            <use href="/assets/sprite-Dt029LRi.svg#next-arrow-12"></use>
                          </svg>
                        </a>
                        <a href="/company/work" className="text-[#ecbb5a] dark:text-[#ecbb5a] [text-decoration:inherit] flex items-center gap-1 hover:text-[var(--content-accent-p3)] block">
                          View Our Work
                          <svg width="12" height="12" className="block align-middle text-[#f5b944]">
                            <use href="/assets/sprite-Dt029LRi.svg#next-arrow-12"></use>
                          </svg>
      ...
      <footer className="relative border-t border-[var(--stroke-secondary-p3)] mt-28 min-[1200px]:mt-48"></footer>
    </>
  )
}