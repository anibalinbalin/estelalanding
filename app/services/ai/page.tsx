...
export const aiContent = {
  en: {
    ...
    pipelinesDesc: "Document processing, automated QA, data routing, content generation. We design the pipeline, the AI does the heavy lifting, and a human signs off. Demos are easy; production is where AI gets found out. We build for the second part.",
  ...
  es: {
    ...
    pipelinesDesc: "Procesamiento de documentos, QA automatizado, enrutamiento de datos, generación de contenido. Diseñamos el pipeline, la IA hace el trabajo pesado y un humano firma. Las demos son fáciles; la producción es donde la IA queda en evidencia. Construimos para la segunda parte.",
