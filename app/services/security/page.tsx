...
const content = {
  en: {
    ...
    backupDesc: "Data protected across multiple layers: a local Synology NAS for fast recovery, Wasabi/AWS cloud storage for long-term disaster recovery, and automated off-hours verification to ensure data integrity.",
    ...
    stackSubtitle: "Every piece, best in class.",
  ...
  es: {
    ...
    backupDesc: "Los datos, protegidos en múltiples capas: un NAS Synology local para una recuperación rápida, almacenamiento en la nube de Wasabi / AWS para una recuperación de largo tiempo atrás, y verificación automatizada fuera de horas de trabajo para garantizar integridad de datos.",
    ...
    stackTitle: "Stack de seguridad",
    stackSubtitle: "Cada pieza, la mejor en su categoría.",
    sentinelTitle: "Endpoints: SentinelOne",
