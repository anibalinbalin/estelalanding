...
const content = {
  ...
  es: {
    ...
    backupDesc: "Los datos, protegidos en varias capas: NAS Synology conectado en el LAN local para recuperación rápida, almacenamiento en la nube de Wasabi / AWS para una recuperación de largo tiempo, verificación automatizada fuera de horas de trabajo para confirmar integridad de datos.",
    ...
    stackSubtitle: "Cada decisión, la mejor en su área.",
    sentinelTitle: "Endpoints: SentinelOne",
