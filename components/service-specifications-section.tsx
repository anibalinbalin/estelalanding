...
export function ServiceSpecificationsSection() {
  ...
  const content = {
    ...
    es: {
      ...
      subtitle: 'Especificaciones de hardware y software para nuestras implementaciones estándar.',
      sections: {
        compute: {
          title: 'Infraestructura de Cómputo',
          specs: {
      ...
      cta: {
        title: 'Un Hardware que Crece con Usted',
        button: 'CONTÁCTENOS'
      }
    }
  }
