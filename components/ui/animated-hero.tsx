...
function Hero() {
  ...
  const content = {
    en: {
      ...
      subtitleMachine: "AI engineering and development. Pipelines and agents that take on the work nobody should do by hand — and the private infrastructure to run them, built by people who answer for the results.",
    ...
    es: {
      ...
      subtitleMachine: "Ingeniería de IA y desarrollo. Pipelines y agentes que se encargan del trabajo que nadie debería hacer a mano — y la infraestructura privada para ejecutarlos, construida por gente que responde por los resultados.",
