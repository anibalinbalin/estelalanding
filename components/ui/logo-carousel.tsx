...
function LogoCarousel({ columnCount = 2 }: { columnCount?: number }) {
  ...
  const allLogos: Logo[] = useMemo(() => {
    ...
    return [
      ...
      { name: "DSR360", id: 10, img: `/company_logos/logos/${logoFolder}/dsr360.png` },
      ...
      { name: "Mueca", id: 14, img: `/company_logos/logos/${logoFolder}/mueca.png` },
      ...
      { name: "Producrers", id: 19, img: `/company_logos/logos/${logoFolder}/producrers.png` },
