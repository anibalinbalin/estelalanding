...
export const StorageSection = () => {
  ...
  const content = {
    en: {
      ...
      description: "they are the soul of why we've stayed small, why our clients stay with us, and why we still answer our own phones after 13 years.",
      additionalInfo: "",
      features: [
        "Truth Over Comfort",
        "People Over Profit", 
      ...
      onDemandDesc1: "We tell clients when they don't need new hardware. We admit when we're not the right fit. We share bad news quickly and honestly.",
      onDemandDesc2: "If this means losing a sale, so be it. Trust is worth more than any contract.",
      openZfsTitle: "People Over Profit",
      openZfsDesc: "We've turned down million-dollar projects that didn't align with our values. We've spent weekends helping clients who couldn't afford emergency rates. Because relationships outlast transactions.",
      ...
      coDesignFeatures: [
        "We are 5 people by choice, not circumstance. We've had offers to grow 10x. We said no.",
      ...
      ctaTitle: "We study Renaissance art because system design is composition",
      ctaSubtitle: "We read philosophy because technology serves humanity",
  ...
  return (
    <section className="w-full py-20 lg:py-40">
      ...
      <div className="container mx-auto px-5 sm:px-10">
        ...
        <div className="m-auto grid max-w-[1200px] grid-cols-[repeat(12,minmax(0,1fr))] gap-6 min-[600px]:gap-6 min-[1000px]:gap-8 mb-20 lg:mb-36">
          <div className="col-span-12 min-[800px]:col-span-5">
            <h2 
              className="text-balance m-0 mb-4 text-[1.5625rem] min-[1000px]:text-4xl font-normal min-[1000px]:font-normal leading-8 min-[1000px]:leading-[2.625rem] tracking-wide min-[1000px]:tracking-normal"
              style={{
                fontFamily: 'SuisseIntl, -apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif',
                color: 'var(--content-raise-p3)'
              }}
          ...
          <div className="col-span-12 min-[800px]:col-start-[7] min-[1000px]:col-start-[8] min-[800px]:col-span-6 min-[1000px]:col-span-5 pl-0 min-[600px]:pl-10 min-[1000px]:pl-0">
            <div className="flex flex-row items-start gap-4">
              <div 
                className="mb-3 p-2 text-green-600 bg-green-100"
                style={{
              ...
              >
                <svg width="24" height="24" className="block align-middle">
                  <path d="M21 2l-2 2m-7.61 1.61a5.5 5.5 0 1 1-7.778 7.778 2.5 2.5 0 0 1-1.112-2.224A2.5 2.5 0 0 1 5.5 8.5c0-.974.561-1.81 1.39-2.207a6.5 6.5 0 0 1 11.249-4.678A6.5 6.5 0 0 1 21 2Z" stroke="currentColor" strokeWidth="2" fill="none"/>
                  <path d="M6 14l3 3 5-5" stroke="currentColor" strokeWidth="2" fill="none"/>
                </svg>
              </div>
              <div>
                <h3 
                  className="text-balance m-0 mb-1 text-[.875rem] min-[1000px]:text-base font-normal min-[1000px]:font-normal leading-[1.125rem] min-[1000px]:leading-6 tracking-wider min-[1000px]:tracking-wide"
                  style={{
                    fontFamily: 'SuisseIntl, -apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif',
                    color: 'var(--content-secondary-p3)'
                  }}
            ...
            <div className="flex flex-row items-start gap-4 mt-[calc(1.5rem_*_calc(1_-_var(--tw-space-y-reverse)))] mb-[calc(1.5rem_*_var(--tw-space-y-reverse))]">
              <div 
                className="mb-3 p-2 text-green-600 bg-green-100"
                style={{
                  borderRadius: 'var(--border-radius)',
