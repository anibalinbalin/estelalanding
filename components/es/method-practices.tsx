  ...
  const practices = [
    {
      ...
      description: [
        'Esta regla surgió de una observación simple: la mayoría de los problemas de TI se agravan con el tiempo. Un fallo que parece simple se convierte con el tiempo en problemas mas complejos.'
      ],
      subsection: {
        title: 'Cómo funciona:',
        items: [
    ...
    },
    {
      ...
      description: [
        'Creemos que las empresas deben entender que hay detrás de su infraestructura: cuanto más capaz se vuelve su equipo, más sólida es nuestra alianza.'
      ],
      subsection: null,
      conclusion: []
    }
