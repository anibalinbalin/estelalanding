  ...
  const content = {
    ...
    es: {
      ...
      metric1: {
        ...
        description: "Quien trabaja con nosotros, permanece con nosotros. Esto refleja el valor sostenido y la confianza inquebrantable que construimos juntos. Su estabilidad tecnologica es nuestro compromiso."
      },
      metric2: {
